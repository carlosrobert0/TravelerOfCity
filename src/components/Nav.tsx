                        ...
                        <Fragment key={name + new Date().getTime()}>
                            {
                                name === 'cities' ? (
                                    <Link href="/cities">
                                        <FiMapPin size={24} color={`${router.pathname === link ? '#FFF' : '#ffa585'}`} />
                                    </Link>
                                ) : name === 'categories' ? (
                                    <Link href="/categories">
                                        <FiGrid size={24} color={`${router.pathname === link ? '#FFF' : '#ffa585'}`} />
                                    </Link>
                                ) : (
                                    <Link href="/comments">
                                        <FiMessageSquare size={24} color={`${router.pathname === link ? '#FFF' : '#ffa585'}`} />
                                    </Link>
                                )
                            }
                        </Fragment>
