    ...
    <>
      {
        imagePreview ? (
          <div className="relative w-full">
            <img
              src={imagePreview}
              className={`flex ${hasIcon ? 'h-[120px] w-[120px]' : 'h-64 w-full'} flex-col object-none rounded-lg`}
            />
          ...
          <div className="flex w-full items-center justify-center">
            <label
              ...
              className={`dark:hover:bg-bray-800 flex ${hasIcon ? 'h-[120px] w-[120px]' : 'h-64 w-full'} cursor-pointer 
