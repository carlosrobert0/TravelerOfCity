...
interface DialogAvaliationSent {
  isOpen: boolean;
  onClose: () => void;
}

export function DialogAvaliationSent({ isOpen, onClose }: DialogAvaliationSent) {
  return (
            ...
            >
              <Dialog.Panel className="flex h-full w-[302px] transform flex-col items-center justify-center transition-all">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-4 w-[214px] font-heebo text-base leading-[26px] text-center">Agradecemos pelo seu tempo
                    e colaboração.
                  </p>

                  <button onClick={onClose} className="mt-10 w-[146px] h-12 bg-brand-orange rounded-[10px] font-heebo font-medium text-base leading-[26px] text-shape">Disponha :)</button>
                </div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
